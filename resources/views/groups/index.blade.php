    ...
    <div class="container mb-5">
        ...
        <div class="teacher_exam_table">
            ...
            <div class="exam_table">
                            ...
                            <td class="td-underline">
                                ...
                                <!--a href="{{url('groups/'.$group->id.'/edit')}}" style="float: left; margin-right: 10px;">編輯題組內容</a-->
                                    <a href="{{url('groups/'.$group->id.'/edit')}}"
                                       style="float: left; margin-right: 10px;">編輯題組資訊</a>
                                    <a href="{{url('templates/?group_id='.$group->id)}}"
                                       style="float: left; margin-right: 10px;">編輯題組內容</a>
                                @endif
                            </td>
                            @if(Auth::user()->role >=99)
                ...
                <!-- 指定班級作答彈跳視窗 -->
                <div class="modal fade" id="assignation_exam" tabindex="-1" role="dialog"
                     aria-labelledby="assignation_exam"
                     aria-hidden="true">
